...
#query_file = './refer/data/refcoco+_query_test.json'
...
#pretrained_model = './refer/tfmodel/refcoco+_fc8_seg_highres_iter_18000.tfmodel'

image_dir = '../text_objseg/exp-referit/referit-dataset/images/'
mask_dir = '../text_objseg/exp-referit/referit-dataset/mask/'
query_file = '../text_objseg/exp-referit/data/referit_query_test.json'
bbox_file = '../text_objseg/exp-referit/data/referit_bbox.json'
imcrop_file = '../text_objseg/exp-referit/data/referit_imcrop.json'
imsize_file = '../text_objseg/exp-referit/data/referit_imsize.json'
vocab_file = '../text_objseg/exp-referit/data/vocabulary_referit.txt'

pretrained_model = './refer/tfmodel/refcoco+_fc8_seg_lowres_iter_30000.tfmodel'
