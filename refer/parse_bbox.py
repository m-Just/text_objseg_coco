...
# read all coco image names
coco_list = open(data_path + '/coco_train2014.txt')
img_names = list()
while True:
    img_name = coco_list.readline().split('/')[-1][:-1]
    if img_name == '':
        break
    else:
...
print 'Total', target_cnt, 'images processed'
