...
pretrained_model = './refer/tfmodel/refcoco+_fc8_seg_highres_init.tfmodel'
...
# Data Params
data_folder = './refer/data/train_batch_seg/'
data_prefix = 'refcoco+_train_seg'

# Snapshot Params
snapshot = 6000
snapshot_file = './refer/tfmodel/refcoco+_fc8_seg_highres_iter_%d.tfmodel'
